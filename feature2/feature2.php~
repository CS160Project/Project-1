...
<?php
    ...
    echo "Demo for Location Searching"."<br />"."<br />";
    echo "Search URL: ".$Search;
    echo "<br/>";
...
function getArticles($page) {
	...
	foreach($items as $post) {
        ...
        echo "<br />Displaying Origin and Destination from the site result<br />";
	echo "Origin:" ;
        echo $lOrigin;
        echo "<br/>";
        echo "Destination: ";
    ...
    if(count($items) == 0)
    {
        ...
        $lFilePath = fopen('results.json', 'w');
